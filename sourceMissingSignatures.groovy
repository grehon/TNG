...
def cli = new CliBuilder(usage: 'groovy sourceMissingSignatures.groovy [options]',
                         header: 'Options:')
...
imageFiles.each{ file -> 
    ...
    db.eachRow('SELECT system_no, company_no, unique_id_no, bol_number, signature_file_name, actual_service_date, route_date FROM cops_reporting.distribution_stop_information WHERE bol_number=(\''+bolNum+'\') AND (customer_no = \'90100\' OR customer_no = \'90300\' OR customer_no = \'90400\' OR customer_no = \'90500\' OR customer_no = \'90600\')'){
        delivery ->
...
importReportingLog.close()
goodRecordsLog.close()
